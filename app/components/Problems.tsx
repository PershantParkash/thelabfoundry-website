...
//             Restaurant owners are experts in hospitality, food, and service. But
//             growth introduces a different challenge entirely.
//           </p>
//           <p className="text-base leading-relaxed text-gray-500">
//             More orders. More channels. More staff. More coordination required.
//             Many restaurants continue using processes that worked when they were
//             smaller until those systems break.
//           </p>
//         </div>
//       </div>
...
//         <div className="mb-8">
//           <p className="text-xs font-bold uppercase tracking-widest text-[#6D5DFC]  mb-3">
...
//       <div
//         key={title}
//         className="flex flex-col justify-between gap-4 bg-gray-50 rounded-2xl p-5 hover:border-gray-200 transition-colors duration-200"
//       >
...
//           </p>
//           <div>
//             <p className="text-base font-semibold text-gray-900 leading-relaxed mb-1">
//               {title}
//             </p>
...
//         <div className="pt-3 border-gray-100 flex justify-end">
...
export default function RootCause() {
  return (
    <section>
      {/* ── Top block: image + root-cause text ── */}
      ...
      {/* ── Bottom block: "Does this sound familiar?" — cream bg matching hero ── */}
      <div className="bg-[#ffffff] b  px-6 md:px-20">
